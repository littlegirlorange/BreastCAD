...
class EditBox(VTKObservationMixin):
  ...
  def __init__(self, parent=None, optionsFrame=None):
    ...
    self.editorBuiltins = {}
    self.editorBuiltins["PaintEffect"] = MyEditorLib.PaintEffect
    self.editorBuiltins["DrawEffect"] = MyEditorLib.DrawEffect
    self.editorBuiltins["ThresholdEffect"] = MyEditorLib.ThresholdEffect
    self.editorBuiltins["RectangleEffect"] = MyEditorLib.RectangleEffect
    self.editorBuiltins["LevelTracingEffect"] = MyEditorLib.LevelTracingEffect
    self.editorBuiltins["MakeModelEffect"] = MyEditorLib.MakeModelEffect
    self.editorBuiltins["ErodeEffect"] = MyEditorLib.ErodeEffect
    self.editorBuiltins["DilateEffect"] = MyEditorLib.DilateEffect
    self.editorBuiltins["ChangeLabelEffect"] = MyEditorLib.ChangeLabelEffect
    self.editorBuiltins["RemoveIslandsEffect"] = MyEditorLib.RemoveIslandsEffect
    self.editorBuiltins["IdentifyIslandsEffect"] = MyEditorLib.IdentifyIslandsEffect
    self.editorBuiltins["SaveIslandEffect"] = MyEditorLib.SaveIslandEffect
    self.editorBuiltins["ChangeIslandEffect"] = MyEditorLib.ChangeIslandEffect
    self.editorBuiltins["GrowCutEffect"] = MyEditorLib.GrowCutEffect
    self.editorBuiltins["WatershedFromMarkerEffect"] = MyEditorLib.WatershedFromMarkerEffect
    self.editorBuiltins["FastMarchingEffect"] = MyEditorLib.FastMarchingEffect
    self.editorBuiltins["WandEffect"] = MyEditorLib.WandEffect
    ...
    if not optionsFrame:
      ...
      self.optionsFrame.setLayout(qt.QVBoxLayout())
    else:
